...
tableName = "/home/joao/Documentos/trabalho/mapbiomas2.0/created_orders.csv"

# The location of the input data in Google Cloud Storage.
GCS_BUCKET = 'alerta-sccon'

# The uri prefix of each image
URI_PREFIX = "gs://{}/PLANET/images-emergency/{}/{}/PSScene4Band/{}_3B_AnalyticMS_clip.tif"

# The Earth Engine image collection to write to.
EE_COLLECTION = 'projects/nexgenmap/MapBiomas2/PLANET/images'
...
for i in range(nImages):
    ...
    tifUri = URI_PREFIX.format(
        GCS_BUCKET, table[i]['alert_id'], table[i]['token'], table[i]['image_id'])
